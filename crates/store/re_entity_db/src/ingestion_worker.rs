...
///
/// This module provides CPU-intensive Arrow message processing off the UI thread.
///
/// # Platform Support
///
    ...
    impl IngestionWorkerImpl {
        ...
        pub fn new() -> Self {
            let (input_tx, input_rx) =
                crossbeam::channel::bounded::<WorkItem>(WORK_QUEUE_CAPACITY);
...
mod tests {
    ...
    use re_log_types::{
        NonMinI64, StoreId, StoreKind, TimeInt, TimePoint, Timeline, entity_path,
    };
    ...
    fn test_worker_thread_exits_on_drop() {
        ...
        // No assertion needed - successful completion means thread exited
    }
